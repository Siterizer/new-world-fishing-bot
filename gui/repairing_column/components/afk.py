...
def repairing_column_afk(repairing_column):
    ...
    repairing_column_enable_container.grid(row=6, column=0, pady=(0, 5))
    repairing_column_enable_text = Label(repairing_column_enable_container, text="Move after repair:")
    ...
    change_repair_afk_state(repairing_column_enable_button)
    change_repair_afk_state(repairing_column_enable_button)
    repairing_column_enable_button.configure(command = partial(change_repair_afk_state, repairing_column_enable_button))
