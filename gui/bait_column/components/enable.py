...
from gui.gui_functions import change_repair_button_state, change_bait_button_state
...
def bait_column_enable(bait_column):
    ...
    change_bait_button_state(bait_column_enable_button)
    bait_column_enable_button.configure(command = partial(change_repair_button_state, bait_column_enable_button))
    bait_column_enable_button.grid(row=0, column=1, padx=(0, 13))
