...
def bait_equip_column_position(bait_column, config):
    ...
    bait_equip_button_column_position_x_scale = Scale(
        bait_equip_button_column_position_x_container,
        from_=0,
        to=config["resolution"]["x"],
        orient=HORIZONTAL,
        variable=config["bait"]["equip_button_x"],
    )
    bait_equip_button_column_position_x_scale.grid(row=0, column=1)
    bait_equip_button_column_position_x_entry = Entry(
        bait_equip_button_column_position_x_container,
        width=4,
        textvariable=config["bait"]["equip_button_x"],
    )
    ...
    bait_equip_button_column_position_y_scale = Scale(
        bait_equip_button_column_position_y_container,
        from_=0,
        to=config["resolution"]["y"],
        orient=HORIZONTAL,
        variable=config["bait"]["equip_button_y"],
    )
    bait_equip_button_column_position_y_scale.grid(row=0, column=1)
    bait_equip_button_column_position_y_entry = Entry(
        bait_equip_button_column_position_y_container,
        width=4,
        textvariable=config["bait"]["equip_button_y"],
    )
