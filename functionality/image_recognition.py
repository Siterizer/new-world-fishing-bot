...
nw_config_path = path.expandvars(
    r'%APPDATA%\AGS\New World\user_preload_settings.cfg')
...
def pixel_match(img, matcher):
    lower, upper = ([matcher[0] - COLOR_WAGES, matcher[1] - COLOR_WAGES,  matcher[2] - COLOR_WAGES],
